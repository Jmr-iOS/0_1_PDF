 ...
 *
 *  @section    Example
 *                  (Swift) https://github.com/fcamichel/ZoomingPDFViewer
 *                  (Obj-C) https://developer.apple.com/library/ios/samplecode/ZoomingPDFViewer/Introduction/Intro.html#//apple_ref/doc/uid/DTS40010281
 *
 * 	@notes		x
 *
 * 	@section	Opens
